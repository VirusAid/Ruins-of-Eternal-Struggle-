...
- 6 уникальных профессий и сценариев с русской локализацией
- 6 сюжетных линий с цепочками миссий, сходящихся в финальной локации
- **Ruins Echoes** — атмосферные записки погибших выживших
- **Объект «Апокалипсис»** — уникальная подземная локация с 5 уровнями
- **Лор-документы «Эхо»** — сюжетные документы об Объекте «Нулевой»
- **Эхо Катастрофы** — иммерсивные видения прошлого с галлюцинациями
- **Свидетели катастрофы** — 5 уникальных NPC с глубоким лором и системой репутации
- **Радиочастота 47.3 Гц** — динамическая радиосистема, меняющаяся по мере прохождения
- **Радиофинал «Последняя передача»** — вершина сюжета: маяк, ответный сигнал, надежда
- **Мутационный квест** — выбор: очиститься или принять мутации навсегда
- **Аномальная погода** — радиационные бури, кислотный дождь, мутагенная дымка
- **Динамическая экономика фракций** — цены зависят от спроса и предложения
- **Война трёх сторон** — 3 фракции (Восход, Отражение, Свободные) с 15 уникальными NPC, 30 миссиями, 3 романтическими линиями и системой репутации
- Переработанные боевые механики и хардкорное выживание
