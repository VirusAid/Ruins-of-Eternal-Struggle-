...
Документы разбросаны по миру и при нажатии **`a`** → «Прочитать/Осмотреть» показывают полный текст со всплывающим попапом. Читать можно неограниченное количество раз.
